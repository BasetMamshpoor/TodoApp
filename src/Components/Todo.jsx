...
const Todo = ({ value, handlDelete, handlEdit }) => {
    return (
        <article className="grocery-item">
            <p className="todo">{value.title}</p>
            <div className="btn-container">
                <button onClick={()=>handlEdit(value.id)} type="button" className="edit-btn">
                ...
                <button onClick={()=>handlDelete(value.id)} type="button" className="delete-btn">
